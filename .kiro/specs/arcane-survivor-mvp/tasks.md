...
- [x] 3. Implement core entity: Walker
  ...
  - [x] 3.2 Write unit tests for Walker entity
  ...
  - [x] 3.3 Write property test for Walker lane assignment
    - **Property 10: Lane Assignment**
    - **Validates: Requirements 3.8**
  
  - [x] 3.4 Write property test for Walker vertical movement
    - **Property 11: Walker Vertical Movement**
    - **Validates: Requirements 4.1**

- [x] 4. Implement core entity: Projectile
  - [x] 4.1 Create Projectile class with middleclass
  ...
  - [x] 4.2 Write unit tests for Projectile entity
  ...
  - [x] 4.3 Write property test for Projectile velocity
    - **Property 6: Projectile Velocity**
    - **Validates: Requirements 2.4**

- [x] 5. Implement core entity: XP Orb
  - [x] 5.1 Create XPOrb class with middleclass
  ...
  - [x] 5.2 Write unit tests for XP Orb entity
    - Test activate sets position and spawn time
    - Test lifetime expiration after 30 seconds
    - Test collect behavior
    - _Requirements: 5.1, 5.2_
  
  - [x] 5.3 Write property test for XP Orb lifetime
    - **Property 16: XP Orb Lifetime**
    - **Validates: Requirements 5.1**

- [x] 6. Implement Arcane Bolt ability
  - [x] 6.1 Create ArcaneBolt class with middleclass
  ...
  - [x] 6.2 Write unit tests for Arcane Bolt ability
  ...
  - [x] 6.3 Write property test for ability cooldown independence
    - **Property 4: Ability Cooldown Independence**
    - **Validates: Requirements 2.8**
  
  - [x] 6.4 Write property test for nearest enemy targeting
    - **Property 5: Nearest Enemy Targeting**
    - **Validates: Requirements 2.3**

- [x] 7. Implement Collision System
  - [x] 7.1 Create collision_system module
  ...
  - [x] 7.2 Write property test for distance-based collision detection
    - **Property 24: Distance-Based Collision Detection**
    - **Validates: Requirements 8.1, 8.2, 8.3, 8.4, 8.6**

- [x] 8. Implement Combat System
  - [x] 8.1 Create combat_system module
  ...
  - [x] 8.2 Write unit tests for Combat System
  ...
  - [x] 8.3 Write property test for projectile damage application
    - **Property 14: Projectile Damage Application**
    - **Validates: Requirements 2.5**
  
  - [x] 8.4 Write property test for projectile removal on collision
    - **Property 15: Projectile Removal on Collision**
    - **Validates: Requirements 2.6, 12.5**

- [x] 9. Implement Spawner System
  - [x] 9.1 Create spawner_system module
  ...
  - [x] 9.2 Write unit tests for Spawner System
  ...
  - [x] 9.3 Write property test for spawn rate scaling
    - **Property 7: Spawn Rate Scaling**
    - **Validates: Requirements 3.3, 3.4, 3.5, 3.6**
  
  - [x] 9.4 Write property test for maximum concurrent enemies
    - **Property 8: Maximum Concurrent Enemies**
    - **Validates: Requirements 3.9, 12.2**
  
  - [x] 9.5 Write property test for walker spawn position
    - **Property 9: Walker Spawn Position**
    - **Validates: Requirements 3.7**

- [x] 10. Implement Level System
  - [x] 10.1 Create level_system module
  ...
  - [x] 10.2 Write unit tests for Level System
  ...
  - [x] 10.3 Write property test for XP collection on proximity
    - **Property 17: XP Collection on Proximity**
    - **Validates: Requirements 5.2**
  
  - [x] 10.4 Write property test for XP requirement formula
    - **Property 18: XP Requirement Formula**
    - **Validates: Requirements 5.4**
  
  - [x] 10.5 Write property test for level-up trigger
    - **Property 19: Level-Up Trigger**
    - **Validates: Requirements 5.5, 5.6**

- [x] 11. Implement Upgrade System
  - [x] 11.1 Create upgrade_system module
  ...
  - [x] 11.2 Write unit tests for Upgrade System
  ...
  - [x] 11.3 Write property test for upgrade card count
    - **Property 20: Upgrade Card Count**
    - **Validates: Requirements 6.1**
  
  - [x] 11.4 Write property test for new ability availability
    - **Property 21: New Ability Availability**
    - **Validates: Requirements 6.3**
  
  - [x] 11.5 Write property test for tier upgrade availability
    - **Property 22: Tier Upgrade Availability**
    - **Validates: Requirements 6.4**
  
  - [x] 11.6 Write property test for upgrade application
...
- [x] 13. Implement Game State Model
  - [x] 13.1 Create game_state module
  ...
  - [x] 13.2 Write unit tests for Game State Model
    - Test initial state values
    - Test pause/resume state transitions
    - Test endGame sets correct statistics
    - _Requirements: 7.1, 7.4, 7.7_
  
  - [x] 13.3 Write property test for elapsed time increases
    - **Property 33: Elapsed Time Increases**
    - **Validates: Requirements 7.2**

- [x] 14. Implement Ability Registry
  - [x] 14.1 Create ability_registry module
  ...
  - [x] 14.2 Write unit tests for Ability Registry
...
- [x] 15. Implement Game Controller
  - [x] 15.1 Create game_controller module
  ...
  - [x] 15.2 Write integration tests for Game Controller
  ...
  - [x] 15.3 Write property test for game over on hero death
    - **Property 2: Game Over on Hero Death**
    - **Validates: Requirements 1.5, 7.6**
  
  - [x] 15.4 Write property test for spawning continues throughout session
    - **Property 32: Spawning Continues Throughout Session**
    - **Validates: Requirements 3.1**

- [x] 16. Implement UI Components
  - [x] 16.1 Create HealthBar UI component
  ...
  - [x] 16.2 Create XPBar UI component
  ...
  - [x] 16.3 Create AbilityIndicator UI component
  ...
  - [x] 16.4 Create UpgradeCard UI component
  ...
  - [x] 16.6 Write property test for health bar accuracy
    - **Property 25: Health Bar Accuracy**
    - **Validates: Requirements 10.1**
  
  - [x] 16.7 Write property test for XP bar accuracy
    - **Property 26: XP Bar Accuracy**
    - **Validates: Requirements 10.3**
  
  - [x] 16.8 Write property test for ability indicator synchronization
    - **Property 29: Ability Indicator Synchronization**
    - **Validates: Requirements 10.6, 10.7**

- [x] 17. Implement Menu Scene
  - [x] 17.1 Create menu scene with Composer
  ...
  - [x] 17.2 Write unit tests for Menu Scene
...
- [x] 18. Implement Game Scene
  - [x] 18.1 Create game scene with Composer
  ...
  - [x] 18.2 Add upgrade UI overlay to game scene
  ...
  - [x] 18.3 Add UI update logic to game scene
  ...
  - [x] 18.4 Write integration tests for Game Scene
  ...
  - [x] 18.5 Write property test for time display format
    - **Property 27: Time Display Format**
    - **Validates: Requirements 10.4**
  
  - [x] 18.6 Write property test for enemy defeat counter
    - **Property 28: Enemy Defeat Counter**
    - **Validates: Requirements 10.5**
  
  - [x] 18.7 Write property test for scene cleanup on hide
    - **Property 30: Scene Cleanup on Hide**
    - **Validates: Requirements 11.5**

- [x] 19. Implement Game Over Scene
  - [x] 19.1 Create gameover scene with Composer
  ...
  - [x] 19.2 Write unit tests for Game Over Scene
  ...
  - [x] 19.3 Write property test for game over statistics
    - **Property 31: Game Over Statistics**
    - **Validates: Requirements 7.7**

- [x] 20. Checkpoint - Scenes and UI complete
...
- [x] 21. Implement persistent data integration
  - [x] 21.1 Update game over scene to save statistics
  ...
  - [x] 21.2 Write unit tests for persistent data integration
    - Test statistics are saved correctly on game over
    - Test high scores are updated appropriately
    - _Requirements: 7.7_

- [x] 22. Add visual assets and polish
  - [x] 22.1 Create placeholder visual assets
  ...
  - [x] 22.2 Integrate visual assets into entities
...
- [x] 23. Implement error handling and edge cases
  - [x] 23.1 Add error handling to combat system
  ...
  - [x] 23.2 Add error handling to spawner system
  ...
  - [x] 23.3 Add error handling to level system
  ...
  - [x] 23.4 Add error handling to upgrade system
  ...
  - [x] 23.5 Add error handling to collision system
...
- [x] 24. Implement remaining correctness properties as tests
  - [x] 24.1 Write property test for ability slot limit
    - **Property 1: Ability Slot Limit**
    - **Validates: Requirements 1.7, 2.9**
  
  - [x] 24.2 Write property test for walker melee damage
    - **Property 12: Walker Melee Damage**
    - **Validates: Requirements 4.2**
  
  - [x] 24.3 Write property test for walker defeat spawns XP
    - **Property 13: Walker Defeat Spawns XP**
    - **Validates: Requirements 4.5**

- [x] 25. Performance optimization and testing
  - [x] 25.1 Test performance with 30 concurrent walkers
  ...
  - [x] 25.2 Optimize if performance issues found
...
- [x] 26. Final integration and end-to-end testing
  - [x] 26.1 Run full game session test
  ...
  - [x] 26.2 Test edge cases and boundary conditions
  ...
  - [x] 26.3 Verify all property tests pass
